        ...
        <div className="min-h-screen bg-[#FAF6F3] flex flex-col items-center justify-between p-8 pb-12 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full px-4 max-w-lg mx-auto">
                <AnimatePresence mode="wait">
                    ...
                    >
                        {/* Icon Container */}
                        <div className={`w-48 h-48 ${currentData.bgColor} rounded-md flex items-center justify-center mb-12 shadow-lg shadow-black/5`}>
            ...
            <div className="w-full max-w-lg mx-auto flex flex-col items-center gap-10">
                ...
                <div className="flex gap-2.5">
                    {ONBOARDING_STEPS.map((_, i) => (
                        <div
                            key={i}
                            className={`h-1.5 rounded-md transition-all duration-300 ${i === step ? "w-6 bg-[#E97A8D]" : "w-1.5 bg-[#E97A8D]/20"
                                }`}
                        />
                    ))}
                </div>
