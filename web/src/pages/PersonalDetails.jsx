...
export default function PersonalDetails() {
    ...
    const fetchUser = async () => {
        ...
        try {
            ...
            console.error("PersonalDetails load error:", err);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setMessage({ text: "Error: " + (err.response?.data?.error?.message || err.message), type: "error" });
        } finally {
            setSaving(false);
        }
    };
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-50">
                <div className="w-10 h-10 border-4 border-pink-100 border-t-pink-500 rounded-md animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen pb-24 w-full">
            ...
            <div className="bg-white rounded-md p-6 shadow-sm border border-gray-100 space-y-6 mb-8">
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="w-full border border-gray-100 bg-gray-50/50 rounded-md pl-12 pr-4 py-4 outline-none focus:border-pink-500 focus:ring-4 focus:ring-pink-50/50 transition-all font-medium text-gray-700"
                                value={fullName}
                    ...
                    <div>
                        ...
                        <div className="relative opacity-60">
                            ...
                            <input
                                type="email"
                                className="w-full border border-gray-100 bg-gray-100 rounded-md pl-12 pr-4 py-4 outline-none font-medium text-gray-500 cursor-not-allowed"
                                value={user?.email || ""}
                                readOnly
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4 bg-pink-50/50 p-4 rounded-md border border-pink-100">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="w-full bg-pink-500 text-white font-bold py-4 rounded-md flex items-center justify-center gap-2 hover:bg-pink-600 active:scale-[0.98] transition-all disabled:opacity-50 shadow-lg shadow-pink-200"
                >
                    {saving ? (
