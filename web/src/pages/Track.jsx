...
export default function Track() {
    ...
    const fetchTrackingData = async () => {
        try {
            setLoading(true);
            const res = await predictionsApi.getPredictions({ order: "asc" });
            const records = res?.items || (Array.isArray(res) ? res : []);
        ...
        return (
            <div className="bg-slate-50 h-full p-6 pb-24">
                <div className="animate-pulse space-y-6">
                    ...
                    <div className="h-64 bg-white rounded-md shadow-sm"></div>
                    <div className="h-64 bg-white rounded-md shadow-sm"></div>
                </div>
            </div>
        );
    ...
    if (data.length === 0) {
        return (
            <div className="bg-slate-50 h-full min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
                <div className="w-24 h-24 bg-blue-50 rounded-md flex items-center justify-center mb-6">
                ...
                <button
                    ...
                    className="bg-slate-900 text-white px-8 py-4 rounded-md font-medium shadow-md w-full"
                >
                    Start Tracking
                </button>
            </div>
        ...
        <div className="bg-[#f0f4f8] h-full pb-24 font-sans text-slate-800 selection:bg-blue-100">
            ...
            <div className="pt-12 pb-6 px-6 sticky top-0 bg-[#f0f4f8]/80 backdrop-blur-xl z-10">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate(-1)} className="p-2 -ml-2 rounded-md text-slate-500">
            ...
            <div className="px-6 space-y-6">
                ...
                <motion.div
                    ...
                    className="bg-white rounded-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden"
                >
                ...
                <motion.div
                    ...
                    className="bg-white/80 backdrop-blur-xl rounded-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.03)] border border-white"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.03)]"
                    >
                    ...
                    <motion.div
                        ...
                        className="bg-slate-900 rounded-md p-6 relative overflow-hidden text-white shadow-xl shadow-slate-200"
                    >
