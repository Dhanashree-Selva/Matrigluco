        ...
        <div className="min-h-screen bg-[#FDF8F8] flex flex-col items-center justify-center p-8">
            <div className="max-w-6xl mx-auto w-full flex flex-col items-center">
                ...
                >
                    ...
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#EAF6EE] opacity-20 rounded-md -mr-16 -mt-16" />
                    ...
                    <div className="bg-[#FDF8F8] rounded-[32px] p-8 border border-[#F2E9E9] space-y-6 mb-10 text-left">
                        <div className="flex items-center gap-5">
                            <div className="w-12 h-12 bg-white rounded-md flex items-center justify-center text-[#F05578] shadow-sm border border-[#F2E9E9]">
                                <Calendar size={22} />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-5">
                            <div className="w-12 h-12 bg-white rounded-md flex items-center justify-center text-[#5C89FF] shadow-sm border border-[#F2E9E9]">
                                <Phone size={22} />
                            </div>
                            <div>
