                ...
                <div className="p-8 bg-white border-b border-[#F2E9E9] rounded-b-[40px] shadow-sm">
                    ...
                    <div className="relative mb-8">
                        ...
                        <input
                            ...
                            className="w-full bg-[#FDF8F8] rounded-md py-4 pl-12 pr-4 outline-none border border-[#F2E9E9] font-medium text-[#2A2340] focus:ring-4 focus:ring-[#FEE7EC] transition-all"
                        />
                    </div>
                    ...
                    <div className="flex gap-3 overflow-x-auto no-scrollbar -mx-2 px-2">
                        {CATEGORIES.map(cat => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-md text-[10px] font-extrabold uppercase tracking-widest whitespace-nowrap transition-all
                            ...
                            >
                                <div className="flex gap-6">
                                    <div className="relative flex-shrink-0">
                                        ...
                                        <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-md border-4 border-white shadow-sm ${doc.status === 'Online' ? 'bg-green-500' : 'bg-gray-300'}`} />
                                    </div>
                                    ...
                                    <div className="flex-grow">
                                        <div className="flex justify-between items-start mb-1">
                                            ...
                                            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-[#FFF9ED] rounded-md border border-[#FFF0D1]">
                                        ...
                                        <div className="space-y-2 mb-6">
                                            <div className="flex items-center gap-2.5 text-[#9E8A8C]">
                                                <div className="w-6 h-6 rounded-md bg-[#EAF6EE] flex items-center justify-center">
                                                    <MapPin size={12} className="text-[#5C9B73]" />
                                                </div>
                                                <span className="text-[10px] font-bold">St. Mary's Women's Center</span>
                                            </div>
                                            <div className="flex items-center gap-2.5 text-[#9E8A8C]">
                                                <div className="w-6 h-6 rounded-md bg-[#FEE7EC] flex items-center justify-center">
                                        ...
                                        <div className="flex gap-3">
                                            <button
                                                ...
                                                className="flex-[2] py-3.5 bg-[#F05578] text-white text-[10px] font-extrabold rounded-md shadow-lg shadow-pink-100 hover:bg-[#E94D71] transform hover:-translate-y-0.5 active:translate-y-0 transition-all"
                                            >
                                                BOOK APPOINTMENT
                                            </button>
                                            <button
                                                onClick={() => window.open(`https://wa.me/${doc.whatsappNumber}`, "_blank")}
                                                className="flex-1 py-3.5 bg-white border border-[#F2E9E9] rounded-md flex items-center justify-center text-[#2A2340] hover:bg-[#FDF8F8] hover:border-[#F05578] hover:text-[#F05578] transition-all group/wa"
...
function Tag({ label, active, onClick }) {
    return (
        <button
            onClick={onClick}
            className={`px-5 py-2.5 rounded-md text-xs font-bold whitespace-nowrap transition-all ${active ? 'bg-pink-500 text-white shadow-lg shadow-pink-100' : 'bg-white text-gray-500 border border-gray-100 hover:bg-gray-50'}`}
        >
            {label}
        </button>
    );
