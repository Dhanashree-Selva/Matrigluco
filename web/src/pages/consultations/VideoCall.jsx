...
export default function VideoCall() {
    ...
    return (
        <div className="min-h-screen bg-[#FDF8F8] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[400px] h-[400px] bg-[#FEE7EC] rounded-md blur-[100px] opacity-50" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-[#F0F4FF] rounded-md blur-[100px] opacity-50" />

            <div className="max-w-md w-full relative z-10">
                <button
                    onClick={() => navigate(-1)}
                    className="absolute -top-16 left-0 p-3 bg-white rounded-md border border-[#F2E9E9] text-[#2A2340] shadow-sm hover:shadow-md transition-all"
                >
                    <ArrowLeft size={20} />
                </button>
