...
export default function RiskDetails() {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            // Fetch latest report for more clinical values
        ...
        return (
            <div className="h-full bg-[#FDF8F8] flex flex-col items-center justify-center p-6 text-center space-y-6">
                ...
                <button
                    ...
                    className="bg-[#F05578] text-white px-8 py-4 rounded-2xl font-extrabold shadow-lg shadow-pink-100"
                >
                    GET STARTED
                </button>
            </div>
        ...
        <div className="h-full bg-[#FDF8F8] flex flex-col pb-24">
            ...
            <div className="p-6 bg-white border-b border-[#F2E9E9] flex items-center justify-between sticky top-0 z-20">
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => navigate(-1)}
                        className="p-2.5 bg-[#FDF8F8] rounded-full border border-[#F2E9E9] text-[#2A2340]"
                    >
                        <ArrowLeft size={20} />
                    </button>
