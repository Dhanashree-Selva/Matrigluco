        ...
        <div className="h-full bg-[#FDF8F8] flex flex-col pb-24">
            ...
            <div className="p-6 flex justify-between items-center bg-white border-b border-[#F4EAEA]">
                ...
                <button
                    ...
                    className="w-11 h-11 bg-[#FDF8F8] rounded-full flex items-center justify-center border border-[#F4EAEA] text-[#2A2340]"
                >
                    <Settings size={20} />
                </button>
            </div>
            ...
            <div className="p-6 space-y-6">
                ...
                >
                    ...
                    <div className="px-5 py-2 bg-[#FDECEF] text-[#D96B82] rounded-full text-[10px] font-black uppercase tracking-widest inline-flex items-center gap-2">
                        <div className="w-1.5 h-1.5 bg-[#D96B82] rounded-full animate-pulse" />
                        {status}
                    </div>
                </motion.div>
...
function SummaryCard({ label, value, icon: Icon, bg, color }) {
    return (
        <div className="bg-white p-5 rounded-[32px] border border-[#F4EAEA] shadow-sm">
            <div className={`w-11 h-11 ${bg} ${color} rounded-2xl flex items-center justify-center mb-3`}>
                <Icon size={22} />
            </div>
