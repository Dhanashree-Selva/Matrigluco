        ...
        <div className="flex flex-col h-screen bg-[#FDF8F8]">
            ...
            <div className="p-6 bg-white border-b border-gray-100 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate(-1)} className="p-2.5 bg-white rounded-full shadow-sm border border-gray-100">
                        <ArrowLeft className="w-5 h-5 text-gray-700" />
                    </button>
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            <img src={doc.image} alt={doc.name} className="w-10 h-10 rounded-xl object-cover" />
                            <div className={`absolute -bottom-1 -right-1 w-3 h-3 border-2 border-white rounded-full ${doc.status === 'Online' ? 'bg-green-500' : 'bg-amber-400'}`} />
                        </div>
                        <div>
            ...
            <div className="p-6 bg-white border-t border-gray-100 pb-10">
                <div className="flex bg-gray-50 rounded-[28px] items-center px-2.5 py-2.5 gap-2 border border-gray-100 shadow-inner">
                    <button className="w-10 h-10 bg-white shadow-sm rounded-full flex items-center justify-center text-gray-400 group">
                    ...
                    <button
                        onClick={handleSend}
                        className="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center text-white shadow-lg shadow-pink-100 active:scale-95 transition-all"
                    >
