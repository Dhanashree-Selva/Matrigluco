    ...
    return (
        <div className="min-h-screen bg-[#FDF8F8] pb-24">
            ...
            <div className="p-8 bg-white border-b border-[#F2E9E9] rounded-b-[40px] shadow-sm">
                ...
                <div className="bg-[#FEE7EC] p-5 rounded-3xl border border-[#F2E9E9] flex items-center gap-4">
                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#F05578] shadow-sm">
                        <Pill size={24} />
                    </div>
                    <div>
                    ...
                    {PRESCRIPTIONS.map((item, i) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <button className="p-2.5 bg-[#FAFAFA] rounded-xl text-[#9E8A8C] hover:text-[#F05578]">
                                    <Download size={18} />
                                </button>
                            </div>

                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div className="p-4 bg-[#FDF8F8] rounded-2xl border border-[#F2E9E9]">
                            ...
                            <div className="pt-5 border-t border-[#F2E9E9] flex items-center justify-between">
                                ...
                                <span className={`px-3 py-1 rounded-full text-[9px] font-extrabold uppercase tracking-widest ${item.status === 'Active' ? 'bg-[#EAF6EE] text-[#5C9B73]' : 'bg-gray-100 text-gray-400'}`}>
                                    {item.status}
                                </span>
                            </div>
                        </motion.div>
